...
public class EtudiantService {
    ...
    @Caching(
            evict= @CacheEvict(value = "etudiants", allEntries = true),
            put = {@CachePut(value = "etudiantById", key = "#id"),
    ...
    @Caching(
            evict={
                    @CacheEvict(value = "etudiants"),
                    @CacheEvict(value = "etudiantById"),
                    @CacheEvict(value = "etudiantByNom")
            }
    )
